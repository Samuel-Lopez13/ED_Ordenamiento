 ...
 */
public class Mezcla_Vista extends JFrame {
    ...
    private static JButton btnInformacion;
    ...
    public void initComponent(){
        Mezcla_Vista.getBtnInicio().addActionListener(new ActionListener(){
            @Override
        ...
        Mezcla_Vista.getBtnTorneo().addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                Torneo_Vista tc = new Torneo_Vista();
                tc.setVisible(true);
                tc.menu();
        ...
        Mezcla_Vista.getBtnInformacion().addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                Informacion tc = new Informacion();
                tc.setVisible(true);
                dispose();
            }
        });
    ...
    public void menu() {
        Mezcla_Vista.btnMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ejecucion();
            }
    ...
    public void ejecucion() {
        if (valor == 0) {
            Mezcla_Vista.btnInicio.setLocation(Mezcla_Vista.btnInicio.getLocation().x, Mezcla_Vista.btnInicio.getLocation().y);
            Mezcla_Vista.btnTorneo.setLocation(Mezcla_Vista.btnTorneo.getLocation().x, Mezcla_Vista.btnTorneo.getLocation().y);

            Hilo_Controlador mc = new Hilo_Controlador(btnInicio, btnTorneo, btnInformacion, this);
            mc.start();
            valor = 1;
        } else if (valor == 1) {
            btnInicio.setBounds(-175, 40, 175, 35);
            btnTorneo.setBounds(-175, 75, 175, 35);
            btnInformacion.setBounds(-175, 110, 175, 35);
            valor = 0;
        }
    }
    ...
    public static JButton getBtnTorneo() {
        return btnTorneo;
    }
    
    public static JButton getBtnInformacion(){
    ...
    private class Diseno extends JPanel {
        ...
        public Diseno() {
            ...
            btnTorneo = new JButton("Ordenamiento Torneo");
            btnTorneo.setBounds(-175, 75, 175, 35);
            ...
            btnInformacion.setBackground(new Color(217, 217, 217));
            add(btnInformacion);
            ...
            titulo.setIcon(new ImageIcon("src/img/Titulo.png"));
            add(titulo);
